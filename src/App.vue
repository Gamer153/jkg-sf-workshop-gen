...
<template>
  ...
  <ElFooter style="font-size: small;">
    <ElCard style="width: fit-content; margin-left: -20px; margin-top: 16px;">
      <!-- <img src="github-mark-white.svg" height="14" style="vertical-align: auto;"> --> Quellcode: <a href="#0" @click="() => shell.open('https://github.com/Gamer153/jkg-sf-workshop-gen')">GitHub-Repo von Gamer153</a><br>
